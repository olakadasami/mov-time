...
function HomeLayout({ children }) {
    ...
    return (
        <div className="bg-primary-dark h-screen md:overflow-hidden text-primary-light flex">
            ...
            {/* Mobile Nav */}
            <nav className={`w-[280px] h-full pb-8 overflow-y-auto pt-2 absolute top-0 z-50 ${showNav ? "left-0" : "-left-full"} transition-all ease-in-out duration-300 md:hidden bg-secondary-dark text-secondary-light`}>
                <SideNav />
            </nav>

            <main onClick={showNav ? (() => setShowNav(false)) : undefined}
